@AbapCatalog.sqlViewName: 'ZV_BOOKING_001'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Definición de estructura para Booking'
...
define root view ZI_BOOKING_001 

   as select from ztbooking_001 as Booking
